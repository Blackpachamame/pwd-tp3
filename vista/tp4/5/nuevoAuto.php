...
<form id="tp4_eje5" name="tp4_eje5" method="POST" action="abmAuto.php" data-toggle="validator">
	<div class="row mx-md-3 justify-content-center">
		...
		<div class="col-sm-8 col-md-6 col-lg-3 mb-3">
			...
			<input type="number" class="form-control" name="Modelo" id="Modelo" min="1970" max="2021" placeholder="2000" required>
		</div>
		<!-- Dni -->
		<div class="col-sm-8 col-md-6 col-lg-3 mb-3">
