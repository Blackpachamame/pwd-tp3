...
<form id="tp4_eje6" name="tp4_eje6" method="POST" action="../5/abmAuto.php" data-toggle="validator">
	<div class="row mx-md-3 justify-content-center">
		...
		<div class="col-sm-8 col-lg-4 mb-3">
			...
			if ($datos != null) {
				...
				echo "<input type='text' class='form-control' name='Patente' id='Patente' value='$patente' placeholder='$patente' required>";
			} else {
				echo "<input type='text' class='form-control' name='Patente' id='Patente' placeholder='AAA 000' required>";
			}
			?>
		</div>
		<!-- Dni Dueño Nuevo -->
