...
<div class="row mb-5">
  ...
  if (count($persona) > 0) {
    ...
    if (count($arrayautos) > 0) {
      ...
      echo "<div><div class='alert alert-primary d-flex align-items-center mt-5' role='alert'>
  ...
  <!-- Botones -->
  <div class="mb-5">
    <a class="btn btn-dark mb-5" href="listarPersonas.php" role="button"><i class="fas fa-angle-double-left"></i> Regresar</a>
  </div>
