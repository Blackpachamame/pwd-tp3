...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <!-- Nav lateral -->
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse pb-2">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <!-- Acordeon TP1 -->
                    <div class="accordion-item">
                        <h4 class="accordion-header bg-light pt-2" id="flush-headingOne">
                    ...
                    <!-- Acordeon TP2 -->
                    <div class="accordion-item">
                        <h4 class="accordion-header bg-light pt-2" id="flush-headingTwo">
                    ...
                    <!-- Acordeon TP3 -->
                    <div class="accordion-item">
                        <h4 class="accordion-header bg-light pt-2" id="flush-headingThree">
                    ...
                    <!-- Acordeon TP4 -->
                    <div class="accordion-item">
                        <h4 class="accordion-header bg-light pt-2" id="flush-headingFour">
