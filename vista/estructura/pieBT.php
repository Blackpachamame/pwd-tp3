...
<footer class="pt-4 pb-2 text-center">
    <div class="row align-items-center mx-md-5 mx-2">
        <p class="col-8 col-sm-10 text-start">Blog creado con <a href="https://getbootstrap.com/">Bootstrap</a> por <a href="https://github.com/Blackpachamame">Marcos Travaglini</a>.</p>
        <p class="col text-end">
            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-arrow-up-circle" viewBox="0 0 16 16">
