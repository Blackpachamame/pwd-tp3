...
<div class="row mb-5">
    ...
    <!-- Botones -->
    <div class="mb-5">
        <a class="btn btn-primary" href="../ejercicios/nuevaPersona.php" role="button"><i class="fas fa-plus"></i> Agregar</a>
        <a class='btn btn-success' href='../ejercicios/buscarPersona.php' role='button'><i class="fas fa-search"></i> Buscar</a>
        <a class='btn btn-danger' href='../ejercicios/listarPersonas.php' role='button'><i class="fas fa-eye"></i> Ver</a>
    </div>
</div>
