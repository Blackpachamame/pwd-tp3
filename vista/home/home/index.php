...
include_once("../../../control/tp3/general/controlSubeArchivos.php");
...
<div class="text-center mb-5">
    <div class="mt-3 mb-3">
        <img alt="Programación Web Dinámica" class="mt-3 mb-3" src="../../img/logoPWD2.png" width="20%">
...
<div class="row">
    <div class="col-sm-12 mb-5">
        <a class="btn btn-danger" href="../../tp3/3/ejer3TP3.php" role="button">Agregar película <i class="fas fa-angle-double-right"></i></a>
    </div>
</div>
